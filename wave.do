...
add wave -noupdate -expand -group mac_stream_a -group a_tcdm_fifo {/tb_hwpe/i_hwpe_top_wrap/i_mac_top/i_streamer/tcdm_fifo_0[0]/clk}
add wave -noupdate -expand -group mac_stream_a -group a_tcdm_fifo {/tb_hwpe/i_hwpe_top_wrap/i_mac_top/i_streamer/tcdm_fifo_0[0]/req}
add wave -noupdate -expand -group mac_stream_a -group a_tcdm_fifo {/tb_hwpe/i_hwpe_top_wrap/i_mac_top/i_streamer/tcdm_fifo_0[0]/gnt}
add wave -noupdate -expand -group mac_stream_a -group a_tcdm_fifo {/tb_hwpe/i_hwpe_top_wrap/i_mac_top/i_streamer/tcdm_fifo_0[0]/add}
add wave -noupdate -expand -group mac_stream_a -group a_tcdm_fifo {/tb_hwpe/i_hwpe_top_wrap/i_mac_top/i_streamer/tcdm_fifo_0[0]/wen}
add wave -noupdate -expand -group mac_stream_a -group a_tcdm_fifo {/tb_hwpe/i_hwpe_top_wrap/i_mac_top/i_streamer/tcdm_fifo_0[0]/be}
add wave -noupdate -expand -group mac_stream_a -group a_tcdm_fifo {/tb_hwpe/i_hwpe_top_wrap/i_mac_top/i_streamer/tcdm_fifo_0[0]/data}
add wave -noupdate -expand -group mac_stream_a -group a_tcdm_fifo {/tb_hwpe/i_hwpe_top_wrap/i_mac_top/i_streamer/tcdm_fifo_0[0]/r_data}
add wave -noupdate -expand -group mac_stream_a -group a_tcdm_fifo {/tb_hwpe/i_hwpe_top_wrap/i_mac_top/i_streamer/tcdm_fifo_0[0]/r_valid}
...
add wave -noupdate -expand -group mac_stream_b -expand -group b_source -expand -subitemconfig {/tb_hwpe/i_hwpe_top_wrap/i_mac_top/i_streamer/i_b_source/flags_o.addressgen_flags -expand /tb_hwpe/i_hwpe_top_wrap/i_mac_top/i_streamer/i_b_source/flags_o.addressgen_flags.realign_flags -expand} /tb_hwpe/i_hwpe_top_wrap/i_mac_top/i_streamer/i_b_source/flags_o
...
add wave -noupdate -expand -group mac_stream_c -expand -subitemconfig {/tb_hwpe/i_hwpe_top_wrap/i_mac_top/i_streamer/i_c_source/flags_o.addressgen_flags -expand /tb_hwpe/i_hwpe_top_wrap/i_mac_top/i_streamer/i_c_source/flags_o.addressgen_flags.realign_flags -expand} /tb_hwpe/i_hwpe_top_wrap/i_mac_top/i_streamer/i_c_source/flags_o
...
WaveRestoreCursors {{Cursor 1} {307610 ps} 0}
...
update
WaveRestoreZoom {206312 ps} {234168 ps}
